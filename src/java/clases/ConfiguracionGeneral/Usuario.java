...
public class Usuario {
 ...
 public Usuario(String id) {
        String rowSql = "SELECT general_usu_num_identificacion, general_usu_nombre, general_usu_apellido, " +
                        "general_usu_correo_electronico, general_usu_num_celular, general_usu_clave, " +
                        "general_usu_rol, general_usu_estado, general_usu_id_tipo_identificacion " +
                        "FROM dbo.generalUsuario WHERE id= '" + id + "'";
        ...
        try {
            if (result.next()) {
                ...
                this.general_usu_estado = result.getInt("general_usu_estado"); // CORRECCIÓN
  ...
  public void setGeneral_usu_clave(String general_usu_clave) {
    if (general_usu_clave == null || general_usu_clave.trim().isEmpty()) {
        ...
        this.general_usu_clave = general_usu_clave; // Guardamos solo el valor sin "md5()"
    }
}
...
public void setGeneral_usu_estado(int general_usu_estado) {
    ...
    public boolean update() {
        String sql = "UPDATE dbo.generalUsuario SET "
                + "general_usu_num_identificacion='" + general_usu_num_identificacion + "', "
                + "general_usu_nombre='" + general_usu_nombre + "', "
                + "general_usu_apellido='" + general_usu_apellido + "', "
                + "general_usu_correo_electronico='" + general_usu_correo_electronico + "', "
                + "general_usu_num_celular='" + general_usu_num_celular + "', "
                + (general_usu_clave != null && !general_usu_clave.isEmpty()
                    ? "general_usu_clave=CONVERT(VARCHAR(32), HASHBYTES('MD5', '" + general_usu_clave + "'), 2), " 
                    : "")
                + "general_usu_rol='" + general_usu_rol + "', "
                + "general_usu_estado=" + general_usu_estado + ", " // Manejo correcto del INT
                + "general_usu_id_tipo_identificacion=" + (general_usu_id_tipo_identificacion != null ? "'" + general_usu_id_tipo_identificacion + "'" : "NULL") + " "
                + "WHERE id='" + id + "'";
    ...
    public static List<Usuario> getListaEnObjetos(String filtro, String orden) {
        ...
        try {
            while (resultado.next()) {
                ...
                user.setGeneral_usu_estado(resultado.getInt("general_usu_estado"));
